...
def test_node_status_output_and_retry_mapping() -> None:
    workflow = {
        "metadata": {"name": "demo-abc", "labels": {"demo.pipeline.io/pipeline": "demo"}, "annotations": {"demo.pipeline.io/node-map": json.dumps({"train-a": "train-a"}), "demo.pipeline.io/definition-digest": "abc123def456"}},
        "spec": {},
